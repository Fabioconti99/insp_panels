...
def sub_server(localIP,localPort):
    ...
    UDPServerSocket3.bind((localIP,localPort+2))
...
if __name__ == "__main__":
    ...
    velocity_pub = rospy.Publisher("/y_velocity", Float32, queue_size=1)
